...
import'./globals.css'
export const metadata:Metadata={title:'ITS-R-AI-Video-Gen',description:'AI Platform — ITS-R Universe'}
export default function RootLayout({children}:{children:React.ReactNode}){
return(<html lang="en"><body style={{background:'#0a0a0f',color:'#f8fafc',margin:0}}>
<header style={{padding:'1rem 2rem',borderBottom:'1px solid #1e293b'}}><span style={{color:'#d4af37',fontWeight:'bold'}}>ITS-R</span><span style={{color:'#f8fafc',marginLeft:'0.5rem'}}>AI Video Gen</span></header>
{children}
